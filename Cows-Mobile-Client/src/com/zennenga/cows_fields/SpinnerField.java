...
public class SpinnerField extends BaseField {
	...
	/**
	 * Set a reference to the spinner this field refers to. Must be executed before setData
	 * @param s
	 */
	...
	/**
	 * Checks that an item was selected from the spinner and sets the value if it was set.
	 */
	@Override
