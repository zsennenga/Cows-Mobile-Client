...
public class BuildingListener implements OnItemSelectedListener {
		...
		public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
	    	...
	    	if (building.contains("215"))	{
	    		...
	    		populateSpinner(R.id.roomSelectSpinner2,R.array.roomOptions1590, (View) parent.getParent());
	    	}
	    	else if (building.contains("1605"))	{
	    		populateSpinner(R.id.roomSelectSpinner2,R.array.roomOptions1605, (View) parent.getParent());
	    	}
	    ...
	    private void populateSpinner(int fieldID, int arrayID, View v) {
			...
			ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(v.getContext(), arrayID, android.R.layout.simple_spinner_item);
